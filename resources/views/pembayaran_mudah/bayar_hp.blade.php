        ...
        <div class="col-6 col-md-3 mb-4">
            <div class="card text-white bg-info">
                <div class="card-body text-center font-weight-bold">
                    <p class="card-title">Total Pembayaran : <br> Rp {{ number_format($total_user_bayar, 0, ',', '.') }}
                    </p>
            ...
            <div class="card text-white bg-success">
                <div class="card-body font-weight-bold">
                    ...
                    <a href="{{ route('pelanggan.sudahbayar') }}"
                        class="card-text">{{ number_format($totalPendapatanharian_semua, 0, ',', '.') }}</a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Pelanggan
                                        {{ ($pelanggan->currentPage() - 1) * $pelanggan->perPage() + $loop->iteration }}</h5>
                                    <p class="card-text">
