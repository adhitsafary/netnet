        ...
        <div class="col-md-9">
            <form action="{{ route('pembayaran.index') }}" method="GET" class="form-inline">
                <div class="input-group">
                    ...
                    <input type="date" name="date_start" id="date_start" class="form-control ml-2" value="{{ request('date_start') }}" placeholder="Tanggal Mulai">
                    <input type="date" name="date_end" id="date_end" class="form-control ml-2" value="{{ request('date_end') }}" placeholder="Tanggal Akhir">
        ...
        <div class="col-md-3 text-right">
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    <a href="{{ route('pembayaran.export', ['format' => 'pdf', 'date_start' => request('date_start'), 'date_end' => request('date_end')]) }}" class="dropdown-item">PDF</a>
                    <a href="{{ route('pembayaran.export', ['format' => 'excel', 'date_start' => request('date_start'), 'date_end' => request('date_end')]) }}" class="dropdown-item">Excel</a>
                </div>
            </div>
        </div>
    </div>
