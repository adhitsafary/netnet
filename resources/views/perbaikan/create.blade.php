...
@section('konten')
    <div class="container mt-4">
        ...
        <form id="perbaikanForm" action="{{ route('perbaikan.store') }}" method="POST">
            ...
            <select id="nama_plg" name="nama_plg" class="form-control mt-2"></select> <br><br>

            <input type="hidden" id="nama_plg_hidden" name="nama_plg_hidden"> <!-- Input untuk menyimpan nama pelanggan -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#nama_plg').on('select2:select', function(e) {
