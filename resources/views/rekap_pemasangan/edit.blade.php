...
<div class="container mt-4">
    ...
    <form action="{{route('rekap_pemasangan.update', $rekap_pemasangan->id)}}" method="POST">
        ...
        <input type="text" name="tgl_aktivasi" value="{{$rekap_pemasangan -> tgl_aktivasi}}" class="form-control mt-2">

        <label for="">Paket</label>
        <input type="text" name="paket_plg" value="{{$rekap_pemasangan -> paket_plg}}" class="form-control mt-2">
        <label for="">Nominal</label>
        <input type="text" name="nominal" value="{{$rekap_pemasangan -> nominal}}" class="form-control mt-2">
        ...
        <input type="text" name="tgl_pengajuan" value="{{$rekap_pemasangan -> tgl_pengajuan}}" class="form-control mt-2">
