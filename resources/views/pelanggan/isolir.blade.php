    ...
    <div class="">
        ...
        <table class="table table-bordered table-responsive"
            ...
            : '-' }}
                    ...
                    <!-- Riwayat Pembayaran -->
                    <td style="padding: 5px; font-size: 0.85em; text-align: center;">
                        <select name="tanggal_pembayaran" class="form-control" style="width: 100%; padding: 2px; height: 25px;" onchange="this.form.submit()">
                    ...
                    <td style="padding: 5px; font-size: 0.85em; text-align: center;">
                        ...
                        <form action="{{ route('pelanggan.toggleStatus', $item->id) }}" method="POST" style="display: inline;">
                            @csrf
                            <input type="hidden" name="status" value="{{ $item->status_pembayaran === 'Block' ? 'nonblock' : 'block' }}">
